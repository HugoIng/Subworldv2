...
public class LoginActivity extends BaseActivity implements LoginMvpView, LoaderManager.LoaderCallbacks<Cursor> {
    private static final String TAG = "SW UI LoginActivity ";
