package com.deepred.subworld.data;
...
import com.deepred.subworld.util.AndroidComponentUtil;
...
import com.deepred.subworld.util.NetworkUtil;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        SubworldApplication.get(this).getComponent().inject(this);
    }
